...
public class DwOpenModule extends DwOpenGeneric{
	
	public DwOpenModule(DwClient client){
		super(client);
	}

	public int register(String make, String model, String fwVersion, String remAt, Object response) throws IOException, DwOpenException{
		...
		cmd.setCommand(DwOpenCommands.CMD_API_MODULE_REGISTER);
