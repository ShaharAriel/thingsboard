package com.devicewise.tr50.admin.clients;
...
import com.devicewise.tr50.admin.protocol.DwClientAdmin;
...
public class DwMqttClientAdmin extends DwClientAdmin implements MqttCallback{
	...
	public DwMqttClientAdmin() throws IOException, MqttException{
		super();
		pubtoken = new Object();
	}
